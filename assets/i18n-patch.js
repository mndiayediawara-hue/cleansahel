// ============================================================
// I18N POST-RENDER PATCH v2 - Fix encoding
// ============================================================
(function() {
  ...
  const dict = {
    ...
    en: {
      ...
      'nav.raw_material_lots': 'RM Lots',
      'nav.packaging': 'Packaging',
      'nav.recipes': 'Recipes',
      'nav.production': 'Production',
      'nav.lots': 'Lots',
      'nav.lot_generator': 'Generate Lot',
      'nav.recalls': 'Recalls',
    ...
    pt: {
      ...
      'nav.search': 'Pesquisa',
      'nav.scanner': 'Scanner',
      'nav.raw_materials': 'Matérias-Primas',
      'nav.raw_material_lots': 'Lotes de MP',
      'nav.packaging': 'Embalagem',
      'nav.recipes': 'Receitas',
      'nav.production': 'Produção',
      'nav.lots': 'Lotes',
      'nav.lot_generator': 'Gerar Lote',
      'nav.recalls': 'Recalls',
  ...
  function translateDOM(lang) {
    ...
    if (count > 0 && window.console) console.log('[i18n] ' + lang + ': ' + count + ' textos traducidos');
  }
